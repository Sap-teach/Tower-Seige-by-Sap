...
function setup(){
    ...
    blocking1 = new blocks5(620,200,40,40);
    ...
    block9 = new blocks2(1100,304,40,40);
...
blockno8.display();
   blockno9.display();
    ...
    imageMode(CENTER);
    image(polygon_img ,ball.position.x+150,ball.position.y,40,40);
